...
export const SHADE = radial(128, [[0, "rgba(0,0,0,0)"], [0.62, "rgba(0,0,0,0)"], [0.86, "rgba(0,0,0,0.38)"], [1, "rgba(0,0,0,0.85)"]]);
export const RING = (() => {
...
export function dither(seed) {
  ...
  g.fillStyle = "#000000"; g.fillRect(0, 0, 64, 64); let s = seed * 9301 + 49297; const bayer = [0, 8, 2, 10, 12, 4, 14, 6, 3, 11, 1, 9, 15, 7, 13, 5];
